        ...
        <MainLayout>
            <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex gap-4">
                    <button className="btn-secondary flex items-center gap-2"><Share2 className="w-4 h-4" /> Share</button>
                    <button className="btn-primary flex items-center gap-2 px-8"><Download className="w-4 h-4" /> Download PDF</button>
                </div>
            </header>
                    ...
                    <div className="relative w-48 h-48 mb-8">
                        <svg className="w-full h-full transform -rotate-90">
                            ...
                            <motion.circle
                                ...
                                animate={{ strokeDashoffset: 2 * Math.PI * 80 * (1 - report.overallScore / 100) }}
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <span className="text-white/40 font-medium font-inter">Grade {report.grade}</span>
                        </div>
                    </div>
                    <h3 className="text-2xl font-bold mb-2">Excellent Performance!</h3>
                    <p className="text-sm text-green-400 font-bold uppercase tracking-widest">{report.hiringRecommendation}</p>
                </motion.div>
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                <div className="flex-1">
                                    ...
                                    <div className="flex gap-4 items-center mb-6">
                                        ...
                                        <span className={q.answerScore >= 70 ? 'text-green-400 font-bold' : 'text-yellow-400 font-bold'}>{q.answerScore}% Fit</span>
                                    </div>
                                    <div className="p-6 bg-white/5 rounded-2xl flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white/50 leading-relaxed font-light italic">{q.feedback}</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="md:w-72 p-6 bg-indigo-500/5 rounded-2xl border border-indigo-500/10">
                                    ...
                                    <p className="text-sm text-white/50 leading-relaxed font-light">{q.suggestedImprovement}</p>
                                </div>
                            </div>
                        </motion.div>
                    ))}
